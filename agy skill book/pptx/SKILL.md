...
- Scope with the title, communicate the conclusion visually at a glance (4 Visual Pillars: Cards, Diagrams, Charts, Tables), prove it with evidence, then use concise text only where necessary.
